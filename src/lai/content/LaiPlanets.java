    ...
    public static void load() {
        ...
        mathelios = new Planet("mathelios", null, 4f) {{
            ...
            meshLoader = () -> new SunMesh(
                ...
                5, 0.3, 1.7, 1.2, 1,
                1.1f,
                Color.valueOf("6aff7e"),
                Color.valueOf("88ff9c"),
                Color.valueOf("b4ffc4"),
                Color.valueOf("e0ffe8")
            );
        }};
        
        mathexis = new LaiPlanet("mathexis", mathelios, 1f, 3) {
            ...
            final Seq<Obj> obj = new Seq<>();
            {
                ...
                addAtmosphereGas(LaiLiquids.mattery, 0.6f);
                addAtmosphereGas(LaiLiquids.oxygen, 0.6f);
...
//                }
        ...
        mathires = newAsteroid("mathires", mathelios, LaiEnvironmentBlocks.darkgreenStoneWall, LaiEnvironmentBlocks.miceliumBlueWall, 0.4f, 12, 2f, gen -> {
            gen.min = 25;
            gen.max = 35;

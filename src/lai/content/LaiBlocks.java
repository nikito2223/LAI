...
import lai.world.blocks.storage.*;
...
public class LaiBlocks {
    ...
    // projectormoto,
    //power
    powerTower, miniReactor, earthGenerator, oilPowerPlant,
    //storage
    coreCaser, coreActor, tnt, teleportPad, /*rocketPad,
*/
    ...
    public static void load() {
		...
		crusherdrill = new Drill("crusher-drill"){{
            ...
            consumeLiquid(Liquids.water, 0.25f / 180f).boost();
        }};
        ...
        oilPowerPlant = new ConsumeGenerator("oil-power-plant"){{
...
/*        earthGenerator = new ThermalGenerator("earth-generator"){{
        ...
        tnt = new Dynamite("tnt"){{
            ...
            size = 2;
            consumePower(0.5f); // нужна минимальная энергия
        }};

        teleportPad = new TeleportPad("teleport-pad"){{
            requirements(Category.effect, with(Items.lead, 10));
            size = 3;
            consumePower(1.1f); // нужна минимальная энергия
        }};
/*        rocketPad = new RocketPad("rocket-pad"){{
            requirements(Category.effect, with(Items.lead, 10));
            size = 3;
            consumePower(1.1f); // нужна минимальная энергия
        }};*/

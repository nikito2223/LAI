...
public class LaiFx {
    ...
    railExplorerHit = new Effect(28f, 130f, e -> {
        color(LaiPal.lightFreeze);
    
        // ширина и длина ромба
        float w = 12f * e.fout();    // половина толщины
        float h = 24f * e.fout();    // половина длины
    
        // рисуем два треугольника — верх и низ ромба
        Drawf.tri(e.x, e.y, w, h, e.rotation);
        Drawf.tri(e.x, e.y, w, h, e.rotation + 180f);
    }),

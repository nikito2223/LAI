...
public class LaiBlocksTurrets {
	...
	public static void load() {
        ...
        alkaline = new ItemTurret("alkaline"){{
            requirements(Category.turret, with(Items.silicon, 80, lithium, 30));
            size = 4;
            predictTarget = false;
            ...
            ammo(
                natrium, new BulletType(0f, 0f){{
                    shootEffect = Fx.shootBig;
                    smokeEffect = Fx.shootSmokeMissileColor;
                    hitColor = Color.valueOf("bd2525");
    
                    ammoMultiplier = 1f;
                    rangeChange = -8f*9f;
                    reloadMultiplier = 0.9f;
    
                    spawnUnit = new MissileUnitType("lai-alkaline-missile-phase"){{
                        speed = 3.6f;
                        maxRange = 2f;
                        lifetime = 60f * 1.2f;
                        outlineColor = Pal.darkOutline;
                        engineColor = trailColor = Color.valueOf("bd2525");
                        ...
                        weapons.add(new Weapon(){{
                            ...
                            shootOnDeath = true;
                            shake = 10f;
                            bullet = new ExplosionBulletType(420f, 26f){{
                                //mirror stats
                                ammoMultiplier = 1f;
                                rangeChange = -8f*9f;
                                reloadMultiplier = 0.9f;
                                ...
                                fragBullet = new BulletType(){{
                                    ...
                                    spawnUnit = new MissileUnitType("lai-alkaline-missile-surge-split"){{
                                        speed = 4.8f;
                                        maxRange = 6f;
                                        lifetime = 60f * 3.5f;
                                        outlineColor = Pal.darkOutline;
                                        ...
                                        abilities.add(new MoveEffectAbility(){{
                                            ...
                                            rotation = 180f;
                                            y = -9f;
                                            color = Color.grays(0.6f).lerp(Color.valueOf("bd2525"), 0.5f).a(0.4f);
                                            interval = 5f;
                                        }});
                                    }};
                                }};
            ...
            drawer = new DrawTurret("base-"){{
                ...
                new RegionPart("-blade"){{
                    ...
                    moveX = 6f;   // <-- раздвижение в стороны
                    moveRot = -22f;
                    mirror = true;
            ...
            coolant = consume(new ConsumeLiquid(oxygen, 15f / 60f));
            limitRange();
        }};
	}
}
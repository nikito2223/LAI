...
public class UpgradeRector extends ConsumeGenerator {
    ...
    public class UpgradeRectorBuild extends ConsumeGeneratorBuild{
        ...
        public void updateTile(){
            ...
            if(heat > 0){
                float maxUsed = Math.min(liquids.get(Liquids.water), heat / coolantPower);
                heat -= maxUsed * coolantPower;
                liquids.remove(Liquids.water, maxUsed);
            }
        ...
        public void draw(){
            ...
            Draw.alpha(liquids.get(Liquids.water) / liquidCapacity);
            ...
            if(liquidWater > 0)
            {
                ...
                Draw.alpha(liquids.get(outLiquid) / liquidCapacity);

...
public class LaiDuct extends LaiBlock implements Autotiler{
    ...
    public void handlePlacementLine(Seq<BuildPlan> plans){
        ...
        Placement.calculateBridges(plans, (DuctBridge)bridgeReplacement, false, b -> b instanceof LaiDuct || b instanceof StackConveyor || b instanceof Conveyor);
    }

    public class LaiDuctBuild extends Building{
        public float progress;
        public @Nullable Item current;
        public int recDir = 0;
        public int blendbits, xscl, yscl, blending;
        public @Nullable Building next;
        public @Nullable LaiDuctBuild nextc;
        ...
        public void onProximityUpdate(){
            ...
            blending = bits[4];
            next = front();
            nextc = next instanceof LaiDuctBuild d ? d : null;
        }

...
public class LaiConduit extends LaiLiquidBlock implements Autotiler{
    ...
    public @LoadAnno("@-cap") TextureRegion capRegion;
    ...
    public class ConduitBuild extends LaiLiquidBuild implements ChainedBuilding{
